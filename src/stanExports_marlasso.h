...
namespace model_marlasso_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marlasso");
    reader.add_event(157, 155, "end", "model_marlasso");
    return reader;
}
#include <stan_meta_header.hpp>
class model_marlasso
  : public stan::model::model_base_crtp<model_marlasso> {
private:
        int n_year;
        int n_site;
        int n_spp;
        ...
        int fit_dynamicB;
public:
    model_marlasso(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_marlasso_namespace::model_marlasso";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_marlasso_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_marlasso_namespace::model_marlasso stan_model;
#ifndef USING_R
